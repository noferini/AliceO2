...
void customize(std::vector<o2::framework::ConfigParamSpec>& workflowOptions)
{
  ...
  workflowOptions.push_back(ConfigParamSpec{"tof-drm-bitmask", o2::framework::VariantType::Int, 1 /* orbit mismatch*/, {"bit mask of DRM critical errors"}}); // 128 = orbit mismatch
