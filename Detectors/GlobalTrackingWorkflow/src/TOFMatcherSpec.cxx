...
void TOFMatcherSpec::run(ProcessingContext& pc)
{
  ...
  if (mPushMatchable) {
    pc.outputs().snapshot(Output{o2::header::gDataOriginTOF, "MATCHABLES", 0, Lifetime::Timeframe}, mMatcher.getMatchedTracksPair());
  }
...
DataProcessorSpec getTOFMatcherSpec(GID::mask_t src, bool useMC, bool useFIT, bool tpcRefit, bool strict, float extratolerancetrd, bool pushMatchable)
{
  ...
  if (pushMatchable) {
    outputs.emplace_back(o2::header::gDataOriginTOF, "MATCHABLES", 0, Lifetime::Timeframe);
  }
