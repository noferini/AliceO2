...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  o2::globaltracking::InputHelper::addInputSpecs(configcontext, specs, clustermask, nonemask, src, useMC, mcmaskcl, nonemask); // only MC mask for TOF clusters not for tracks

  specs.emplace_back(o2::globaltracking::getTOFMatcherSpec(src, useMC, useFIT, false)); // doTPCrefit not yet supported (need to load TPC clusters?)
